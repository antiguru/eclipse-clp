...
% $Id: umsintro.tex,v 1.2 2009/07/16 09:11:25 jschimpf Exp $
%
...
%For example {\tt gar}\verb.^.D will be expanded into  {\tt garbage\_collect}.
%
...
%This manual, other reports and various public domain
%software can be obtained by anonymous ftp from
%\index{ftp}
%\begin{quote}\begin{verbatim}
%ftp.ecrc.de (141.1.1.1)
%\end{verbatim}\end{quote}
%in the directory {\tt /pub/eclipse}.
