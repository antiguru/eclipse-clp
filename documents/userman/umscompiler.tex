...
predicates:
\begin{description}
\item[\biptxtref{compile(Source)}{compile/1}{../bips/kernel/compiler/compile-1.html}]
\index{compile/1}
...
\item[\biptxtref{compile(Source, Options)}{compile/2}{../bips/kernel/compiler/compile-2.html}]
\index{compile/2}
This is the standard compiler predicate.
Source is usually a file name, other forms are detailed below.
Options is a list of options to control the compilation process, see details below.

\item[\biptxtref{[File1,...,FileN]}{'.'/2}{../bips/kernel/compiler/D-2.html}]
\index{'.'/2}
...
\item[\biptxtref{compile_stream(Stream)}{compile_stream/1}{../bips/kernel/compiler/compile_stream-1.html}]
...
\item[\biptxtref{compile_stream(Stream,Options)}{compile_stream/2}{../bips/kernel/compiler/compile_stream-2.html}]
\index{compile_stream/2}
Like compile_stream/1 but with options list.

\item[\biptxtref{compile_term(Clauses)}{compile_term/1}{../bips/kernel/compiler/compile_term-1.html}]
...
\item[\biptxtref{compile_term(Clauses,Options)}{compile_term/2}{../bips/kernel/compiler/compile_term-2.html}]
...
\item[\biptxtref{:- meta_attribute(Name,Handlers)}{meta_attribute/2}{../bips/kernel/termmanip/meta_attribute-2.html}]
...
\item[\biptxtref{ensure_loaded(Files)}{ensure_loaded/1}{../bips/kernel/compiler/ensure_loaded-1.html}]
...
\item[\biptxtref{lib(Lib)}{lib/1}{../bips/kernel/compiler/lib-1.html}]
\index{lib/1}
