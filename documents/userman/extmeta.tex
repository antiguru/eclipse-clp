...
to \about{Term}, however when all local handlers succeed,
...
and instantiate \about{Res} to either \notation{=} (if the terms are variants)
or \notation{<}
(if \about{TermL} is a proper instance of \about{TermR}). If the terms are
incomparable, the handler should fail. If \about{TermR} is proper instance
of \about{TermL}, the handler should either return \notation{>} or fail.
