...
% END LICENSE BLOCK
%
% $Id: umslanguage.tex,v 1.7 2016/10/07 02:12:22 jschimpf Exp $
%
...
on the application.
Nevertheless, in {\eclipse} it was decided to have the string data type.
One reason is the easier interface to other programming languages.
The other is that users who are aware of the advantages and disadvantages of the
...
\bipref{string_list/2,3}{../bips/kernel/stratom/string_list-2.html},
\bipref{string_chars/2}{../bips/kernel/stratom/string_chars-2.html},
\bipref{number_string/2}{../bips/kernel/stratom/number_string-2.html},
\bipref{term_string/2}{../bips/kernel/termmanip/term_string-2.html},
\bipref{text_to_string/2}{../bips/kernel/stratom/text_to_string-2.html},
\bipref{atomics_to_string/2,3}{../bips/kernel/stratom/atomics_to_string-3.html},
strings can easily be converted to and from other data types.

String manipulation is provided by builtins like
\bipref{string_concat/3}{../bips/kernel/stratom/string_concat-3.html},
\bipref{string_code/3}{../bips/kernel/stratom/string_code-3.html},
\bipref{string_codes/2}{../bips/kernel/stratom/string_codes-2.html},
\bipref{string_char/3}{../bips/kernel/stratom/string_char-3.html},
\bipref{string_chars/2}{../bips/kernel/stratom/string_chars-2.html},
\bipref{split_string/4}{../bips/kernel/stratom/split_string-4.html}, and
\bipref{substring/5}{../bips/kernel/stratom/substring-5.html}.
The regular expression library
\bipref{library(regex)}{../bips/lib/regex/index.html}
