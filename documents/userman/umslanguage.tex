...
% END LICENSE BLOCK
%
% $Id: umslanguage.tex,v 1.3 2009/12/14 17:49:16 kish_shen Exp $
%
...
\index{structures}
{\eclipse} \Index{extended structure notation}%
\index{structure notation|see{extended structure notation}}
...
If a program is consistently written using the extended structure notation
...
extended structure syntax by default. The reason this is not done is that this
can
...
\end{verbatim}
\end{quote}
Note that, as long as the extended structure notation is used,
