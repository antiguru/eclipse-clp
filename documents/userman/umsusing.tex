...
\guitext{Results} section, and then print \texttt{Yes}.
If it finds a solution and there may be more, it will print the solution
found as before, print \texttt{More}, and enable the \guitext{more} button.
...
%------------------------------------------------------------------------
\section{How do I use \texttt{eclipse}?}
%------------------------------------------------------------------------
...
The predicate {\bf help/0}\index{help/0} gives
...
\bipref{compile/1}{../bips/kernel/database/compile-1.html} predicate are used
...
\end{verbatim}
\end{quote}
The \bipref{compile/2}{../bips/kernel/database/compile-2.html} predicate may be used to compile a file or list of
...
The execution of {\eclipse} may be suspended by typing {\bf CTRL-Z} 
...
of the \bipref{lib/1}{../bips/kernel/database/lib-1.html} or
...
programs.
The \bipref{compile/1}{../bips/kernel/database/compile-1.html} predicate automatically adds the suffix to the
...
using \bipref{get_flag/2}{../bips/kernel/env/get_flag-2.html} and \bipref{set_flag/2}{../bips/kernel/env/set_flag-2.html}.
