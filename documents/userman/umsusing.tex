...
\index{query}
If there are uninstantiated variables\index{variables} in the query,
...
%------------------------------------------------------------------------
\subsection{The history mechanism\index{history}}
...
%------------------------------------------------------------------------
\subsection{Getting help\index{help}}
...
%------------------------------------------------------------------------
\section{How do I use {\eclipse} libraries in my programs?\index{libraries}}
%------------------------------------------------------------------------
...
specified by the global flag \flagname{library_path} using the
...
Alternatively the \flagname{library_path} flag may be updated to point
...
called \notationidx{.eclipserc}\index{initialisation file}\label{eclipserc}
...
If \notation{ECLIPSEINIT} is set to an empty string, no initialisation is done.
...
to compile an initialisation file. This can be the \notation{.eclipserc} file,
...
\flagnameidx{prolog_suffix} and can be examined and modified
