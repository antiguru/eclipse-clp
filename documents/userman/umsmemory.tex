...
Consequently its size is increased by the various \biptxtref{compile}{compile/1}{../bips/kernel/compiler/compile-1.html}-predicates,
...
whole predicates (\txtbipref{abolish}{(abolish)/1}{../bips/kernel/compiler/abolish-1.html}) are removed from the system.
