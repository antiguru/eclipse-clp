...
\bipref{make_display_matrix/2}{../bips/kernel/debug/make_display_matrix-2.html}
predicate or the
\bipref{make_display_matrix/5}{../bips/kernel/debug/make_display_matrix-5.html}
predicate.
...
\index{make_display_matrix/2}
\index{make_display_matrix/5}
...
\begin{center}
\centering{
\mbox{\includegraphics{remotetools.eps}} \mbox{\includegraphics{remotetools2.eps}}
}
\end{center}
...
\bipref{tools/0}{../bips/lib/remote_tools/tools-0.html} predicate. When the remote tools have control, the user can
...
\begin{description}
\item[\index{tools/0}tools] Explicitly hands over control to the remote development
...
\item[\index{attached/1}attached(?ControlStream)] 
