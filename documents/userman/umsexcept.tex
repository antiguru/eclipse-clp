...
% END LICENSE BLOCK
%
% $Id: umsexcept.tex,v 1.2 2009/12/14 17:49:15 kish_shen Exp $
%
...
\item if the handler calls \bipref{exit_block/1}%
...
\bipref{exit_block/1}{../bips/kernel/control/exit_block-1.html} may be
...
%\bipref{retract_all/1}{../bips/kernel/dynamic/retract_all-1.html} to remove
...
\item[throw/1]\indextt{throw/1}\mbox{}\\
    Invoke \predspec{exit_block/1} with the interupt's symbolic name.

\item[abort/0]\indextt{abort/0}\mbox{}\\
    Invoke \notation{exit_block(abort)}.
