...
The value of a non-logical variable is set using the \bipref{setval/2}{../bips/kernel/storage/setval-2.html} predicate.
\index{setval/2}
This has the format
\begin{quote}
...
The value of a non-logical variable is retrieved using the \bipref{getval/2}{../bips/kernel/storage/getval-2.html} predicate.
\index{getval/2}
...
If the value of a non-logical variable is an integer, the predicates \bipref{incval/1}{../bips/kernel/storage/incval-1.html}
and \bipref{decval/1}{../bips/kernel/storage/decval-1.html} may be used to increment and decrement the value of the
\index{incval/1}
\index{decval/1}
variable, respectively.
The predicates \bipref{incval/1}{../bips/kernel/storage/incval-1.html} and
\bipref{decval/1}{../bips/kernel/storage/decval-1.html} may be used e.g.\ in a failure-driven loop to provide
...
\bipref{erase_array/1}{../bips/kernel/storage/erase_array-1.html}, e.g.
\index{erase_array/1}
\begin{quote}\begin{verbatim}
erase_array(matrix/2).
\end{verbatim}\end{quote}

The value of an element of the array is set using the \bipref{setval/2}{../bips/kernel/storage/setval-2.html}
\index{setval/2}
predicate. The first argument of \bipref{setval/2}{../bips/kernel/storage/setval-2.html} specifies the element which is
...
Similarly, values of array elements are retrieved by use of the \bipref{getval/2}{../bips/kernel/storage/getval-2.html}
\index{getval/2}
predicate. The first argument of \bipref{getval/2}{../bips/kernel/storage/getval-2.html} specifies the element to be
...
can be updated using \bipref{incval/1}{../bips/kernel/storage/incval-1.html} and \bipref{decval/1}{../bips/kernel/storage/decval-1.html}.
...
The predicate \bipref{current_array/2}{../bips/kernel/storage/current_array-2.html}
...
and the terms obtained by \bipref{getval/2}{../bips/kernel/storage/getval-2.html} are thus not identical
...
over the \bipref{setval/2}{../bips/kernel/storage/setval-2.html} call, the previous value of the global reference is restored
