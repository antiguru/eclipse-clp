...
\begin{center}
\parbox{0.43\textwidth}{\resizebox{0.4\textwidth}{!}{\includegraphics{mapdisplay.ps}}}
...
The countries are identified by numbers displayed within each country. On the
...
\begin{figure}
\begin{center}
\resizebox{0.4\textwidth}{!}{\includegraphics{tktracer.ps}}
\end{center}
...
is shown on two text windows: the bottom `Trace Log' window, which shows
a log of the debugger ports much as a traditional debugger does; and the
...
these bindings can be `refreshed' later on.
...
\button{Show source} button, which opens a source display window to show the
...
\begin{center}
\parbox{0.5\textwidth}{\resizebox{0.48\textwidth}{!}{\includegraphics{tkinspect.ps}}}
\parbox{0.5\textwidth}{\resizebox{0.48\textwidth}{!}{\includegraphics{tkinspect2.ps}}}
...
\resizebox{0.8\textwidth}{!}{\includegraphics{tkdelayedann.eps}}
\subsection{Tracer}
\index{tracer, development tool}
