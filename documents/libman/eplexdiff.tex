...
\item \biptxtref{integers/1}{integers/1!eplex}{../bips/lib/eplex/integers-1.html} only indicates that a
...
specified during solver setup (using \biptxtref{eplex_solver_setup/4}{eplex_solver_setup/4!eplex}{../bips/lib/eplex/eplex_solver_setup-4.html}). This will `synchronise' the bounds of all problem
...
\biptxtref{eplex_get/2}{eplex_get/2!eplex}{../bips/lib/eplex/eplex_get-2.html}.
