...
Constrain Vars to have the domain Domain. A \biptxtrefni{reified}{\#::/3!gfd}{../bips/lib/gfd/HNN-3.html} version is also available.
...
\biptxtrefni{=>/2,3}{=>/2!gfd}{../bips/lib/gfd/EG-2.html} (imply),
\biptxtrefni{<=/2,3}{<=/2!gfd}{} (reverse imply),
...
Constrains each element of Collection to be equal to Y. Simular constraints
...
Constrains Max to be the maximum of the values in Collection. Simularly,
...
Constrains Max to be the maximum of X and Y. Simularly,
...
\biptxtrefni{lex_ge(+Collection1+Collection2)}{lex_ge/2!gfd}{../bips/lib/gfd/lex_ge-2.html} (exicographically greater or equal to),
\biptxtrefni{lex_gt(+Collection1+Collection2)}{lex_gt/2!gfd}{../bips/lib/gfd/lex_gt-2.html} (lexicographically greater than),
\biptxtrefni{lex_le(+Collection1+Collection2)}{lex_le/2!gfd}{../bips/lib/gfd/lex_le-2.html}
(lexicographically less or equal to), Collection2.
\biptxtrefni{lex_lt(+Collection1+Collection2)}{lex_lt/2!gfd}{../bips/lib/gfd/lex_lt-2.html},
(lexicographically less than),
\biptxtrefni{lex_neq(+Collection1+Collection2)}{lex_neq/2!gfd}{../bips/lib/gfd/lex_neq-2.html}
...
Multi-resource cumulatives constraint on specified tasks. A version with
...
Rectangles so that none overlaps. A version where placement of rectangles is 
...
Constrain the tasks with specified start times and durations to not overlap in time. A version with optional tasks is also available:
...
Versions with cost are also available:
\biptxtrefni{circuit(+Succ,++CostMatrix,?Cost)}{circuit/3!gfd}{../bips/lib/gfd/circuit-3.html},
\biptxtrefni{circuit(+Succ,++CostMatrix,+ArcCosts,?Cost)}{circuit/4!gfd}{../bips/lib/gfd/circuit-4.html}.
...
circuit. Versions with cost are also available:
...
\biptxtrefni{circuit_offset_g(+Succ,+Offset)}{circuit_offset_g/2!gfd}{../bips/lib/gfd/circuit_offset_g-2.html}.
...
End. Verions with cost are also available:
\biptxtrefni{ham_path(?Start,?End,+Succ,++CostMatrix,?Cost)}{ham_path/5!gfd}{../bips/lib/gfd/ham_path-5.html},
\biptxtrefni{ham_path(?Start,?End,+Succ,++CostMatrix,+ArcCosts,?Cost)}{ham_path/6!gfd}{../bips/lib/gfd/ham_path-6.html}.

\item[\biptxtrefni{ham_path_offset(?Start,?End,+Succ,+Offset)}{ham_path_offset/4!gfd}{../bips/lib/gfd/ham_path_offset-4.html}]
Constrains elements (offset by Offset) in Succ to form a Hamiltonian
path from Start to End. Versions with cost is also available:
...
Here, variable selection and value choice is done for each labelling,
...
\biptxtrefni{search/6}{search/6!gfd_search}{../bips/lib/gfd_search/search-6.html}, which performs the search. It is 
...
Retrieve the current upper bound of Var. Similarly, \biptxtrefni{get_min/2)}{get_min/2!gfd}{../bips/lib/gfd/get_min-2.html} returns the lower bound.
...
Returns the regret value for the lower bound of Var. Simularly, \biptxtrefni{get_regret_upb/2}{get_regret_upb/2!gfd}{../bips/lib/gfd/get_regret_upb-2.html}
for the upper bound.
...
\begin{itemize}
      ...
      will differ between GFD and IC, and the substitute variables 
