...
op_addr[i++] = (vmcode) &&I_BI_PutCutAM;
op_addr[i++] = (vmcode) &&I_BI_PutCutL;
...
op_addr[i++] = (vmcode) &&I_Get_integeratomAMAM;
...
op_addr[i++] = (vmcode) &&I_MoveLAMJmpA;
op_addr[i++] = (vmcode) &&I_MoveLAMJmpP;
op_addr[i++] = (vmcode) &&I_Put_global_variableAMLCallfA;
op_addr[i++] = (vmcode) &&I_Put_global_variableAMLCallfP;
op_addr[i++] = (vmcode) &&I_Put_global_variableAMLChainA;
op_addr[i++] = (vmcode) &&I_Put_global_variableAMLChainP;
op_addr[i++] = (vmcode) &&I_Put_global_variableAMLJmpA;
op_addr[i++] = (vmcode) &&I_Put_global_variableAMLJmpA;
