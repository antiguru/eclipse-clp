...
% Version:	$Id: tracer.pl,v 1.1 2006/09/23 01:55:38 snovello Exp $
% ----------------------------------------------------------------------

%
% ECLiPSe II debugger -- Port generation
%
% $Id: tracer.pl,v 1.1 2006/09/23 01:55:38 snovello Exp $
%
...
tracemode,invoc,minlevel,maxlevel can be set via trace_mode/2.
...
:- export
	...
	struct(tf(invoc,goal,depth,chp,parent,proc,prio,module)),
