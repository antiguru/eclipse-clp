...
% Version:	$Id: asm.pl,v 1.20 2008/04/11 02:20:27 kish_shen Exp $
% ----------------------------------------------------------------------
...
*/
pass1(WAMList, H, WordList) :-
        hash_create(H),
        instr(code_end, Code_end, _), 
        % made sure there is a code_end at end of instructions
	pass1(WAMList, H, WordList, [o(Code_end)|TList], TList).


pass1([], _, IList, IList, []). % leave IList tail as var.
pass1([Instr|Instrs], H, IList0, IList, TList0) :-
	(instr(Instr, Opc, Typed) ->
	    (fill_wordlist(Opc, Typed, H, IList0, IList1, TList0, TList1) ->
		pass1(Instrs, H, IList1, IList, TList1)
...
fill_wordlist(pseudo, Typed, H, IList0, IList, TList0, TList) :- !,
% asm psuedo instruction, do not add Opc to list
	asm_args(Typed, H, IList0, IList, TList0, TList).
fill_wordlist(Opc, Typed, H, IList0, IList, TList0, TList) :-
	integer(Opc), 
	IList0 = [o(Opc)|IList1],
	asm_args(Typed, H, IList1, IList, TList0, TList).


asm_args([], _H, IList0, IList, TList0, TList) ?- 
	IList0 = IList, TList0 = TList.
asm_args([Arg|Args], H, IList0, IList, TList0, TList) ?-
	asm_arg(Arg, H, IList0, IList1, TList0, TList1),
	asm_args(Args, H, IList1, IList, TList1, TList).

/* asm_arg(+Arg, +Hash, -InstrIn, -InstrOut, +TableIn, -TableOut)
...
*/
asm_arg(a(A), _H, IList0, IList, TList0, TList) ?-
	integer(A), A >= 0, !,
	TList0 = TList,
	IList0 = [a(A)|IList].
asm_arg(arglist(AList), _H, IList0, IList, TList0, TList) ?-
	nonvar(AList), !,
	TList0 = TList,
	( foreach(Arg,AList), fromto(IList0,[Arg|IList1],IList1,IList) do
	    nonvar(Arg), Arg = a(A), integer(A), A>0
	).
asm_arg(y(Y), _H, IList0, IList, TList0, TList) ?-
	integer(Y), Y >= 0, !,
	TList0 = TList,
	IList0 = [y(Y)|IList].
asm_arg(t(X), _H, IList0, IList, TList0, TList) ?-
	integer(X), !,
	TList0 = TList,
	IList0 = [t(X)|IList].
asm_arg(pw(N), _H, IList0, IList, TList0, TList) ?-
	integer(N), !, % no wrappers 
	TList0 = TList,
	IList0 = [pw(N)|IList]. 
asm_arg(edesc(EDesc), _H, IList0, IList, TList0, TList) ?- !,
	encode_edesc(EDesc, IList0, IList, TList0, TList).
asm_arg(i(N), _H, IList0, IList, TList0, TList) ?-
	integer(N), !, 
	TList0 = TList,
	IList0 = [N|IList].
asm_arg(f(N), _H, IList0, IList, TList0, TList) ?- 
	float(N), !,
	TList0 = TList,
	IList0 = [N|IList]. 
asm_arg(atom(A), _H, IList0, IList, TList0, TList) ?- 
	atom(A), !,
	TList0 = TList,
	IList0 = [A|IList].
asm_arg(s(S), _H, IList0, IList, TList0, TList) ?- 
	string(S), !,
	TList0 = TList,
	IList0 = [S|IList].
asm_arg(ref(L0), H, IList0, IList, TList0, TList) ?-
	valid_reflab(L0), !,
        label_idx_to_var(L0, H, L),
	TList0 = TList,
	IList0 = [ref(L)|IList].
asm_arg(label(L0), H, IList0, IList, TList0, TList) ?-
	( var(L0) ->
            L0 = L
        ; integer(L0) ->
            label_idx_to_var(L0, H, L)
...
asm_arg(func(N/A), _H, IList0, IList, TList0, TList) ?-
	atom(N), integer(A), !,
	TList0 = TList,
	IList0 = [functor(N/A)|IList].
asm_arg(proc(P), _H, IList0, IList, TList0, TList) ?-
	is_proc(P), !,
	TList0 = TList,
	IList0 = [proc(P)|IList].
asm_arg(vmask(VList), _H, IList0, IList, TList0, TList) ?- 
	sort(VList,Sorted),
	(foreach(E,Sorted) do integer(E)), !,
	Sorted = [First|_],
	TList0 = TList,
	IList0 = [y(First),ymask(Sorted)|IList]. 
asm_arg(nvmask(NVList), _H, IList0, IList, TList0, TList) ?-
...
asm_arg(nv(VN), _H, IList0, IList, TList0, TList) ?-
	atom(VN), !,
	TList0 = TList,
	IList0 = [nv(VN)|IList].
asm_arg(tags(LList), H, IList0, IList, TList0, TList) ?-
...
asm_arg(tags(LList,DefRef), H, IList0, IList, TList0, TList) ?-
	valid_ref(DefRef0),
        DefRef0 = ref(L0),
        DefRef = ref(L),
        label_idx_to_var(L0, H, L),
...
asm_arg(port(P), _H, IList0, IList, TList0, TList) ?-
	integer(P), !, % treat in raw form as an int for now
	TList0 = TList,
	IList0 = [P|IList].
asm_arg(valtag(C), _H, IList0, IList, TList0, TList) ?- 
	\+ nonground(C), !,
	smallbignum_check(C),
	TList0 = TList,
	IList0 = [val(C),tag(C)|IList].
asm_arg(tagval(C), _H, IList0, IList, TList0, TList) ?-
	\+ nonground(C), !,
	smallbignum_check(C),
	TList0 = TList,
	IList0 = [tag(C),val(C)|IList].
asm_arg(mv(M), _H, IList0, IList, TList0, TList) ?-
	atom(M), !,
	TList0 = TList,
	IList0 = [mv(M)|IList].
asm_arg(an(Att), _H, IList0, IList, TList0, TList) ?-
	atom(Att), !,
	TList0 = TList,
	IList0 = [an(Att)|IList].
asm_arg(try{table:Table,ref:TLabel}, H, IList0, IList, TList0, TList) ?-
...
asm_arg(tab{table:Table,type:Type}, H,  IList0, IList, TList0, TList) ?- !,
	table_size(Table, Type, Size),
	IList0 = [ref(TLabel), Size|IList],
	make_switch_table(Type, H, TLabel, Table, TList0, TList).
asm_arg(o(N), _H, IList0, IList, TList0, TList) ?-
	integer(N), N >= 0, !, 
	TList0 = TList,
	IList0 = [o(N)|IList].
asm_arg(tref(L), H, IList0, IList, TList0, TList) ?- !,
% for assembly, treat just like normal refs
	asm_arg(ref(L), H, IList0, IList, TList0, TList).
asm_arg(skip(_S), _H, _IList0, _IList, _TList0, _TList) ?- !,
