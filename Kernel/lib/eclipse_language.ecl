...
% Version:	$Id: eclipse_language.ecl,v 1.22 2016/09/20 22:27:38 jschimpf Exp $
...
:- reexport array_sort / 4 from sepia_kernel.
...
:- reexport close / 2 from sepia_kernel.
...
:- reexport read_string / 5 from sepia_kernel.
...
:- reexport store_insert / 3 from sepia_kernel.
:- reexport store_set / 3 from sepia_kernel.
:- reexport store_remove / 3 from sepia_kernel.
:- reexport store_update / 4 from sepia_kernel.
:- reexport store_test_and_set / 4 from sepia_kernel.
...
:- reexport term_variables_array / 2 from sepia_kernel.
:- reexport term_variables_count / 2 from sepia_kernel.
...
:- reexport unschedule_suspension / 1 from sepia_kernel.
